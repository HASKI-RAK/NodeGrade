...
A participant's workshop workspace identity SHALL survive page reloads within the same
browser profile for the duration of the workshop.
...
```gherkin
Given two different workshop workspaces
